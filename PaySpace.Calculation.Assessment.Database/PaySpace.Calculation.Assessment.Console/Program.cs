...
class Program
  ...
  static List<TaxRetrieve> GetTaxCalculations(string connectionString)
    {
  ...
  static List<TaxUpdate> CalculateTaxes(List<TaxRetrieve> taxCalculations, string connectionString, IServiceProvider services)
    {
  ...
  static void UpdateTaxCalculations(List<TaxUpdate> updateParameters, string connectionString)
    {
    TaxCalculationsProvider taxCalculationsProvider = new TaxCalculationsProvider(connectionString);
